...
const Table: FC<TableProps> = ({
  ...
  return (
    <>
      <div className="relative mx-auto flex flex-col overflow-x-auto shadow-md sm:rounded-lg md:min-w-[50%]">
        <h1 className="p-4 text-2xl text-white md:p-6">{headerText}</h1>
          ...
          <tbody>
            {inputArray.map((item) => (
              ...
              >
                ...
                <td className="px-6 py-4">{item.protein}</td>
                <td className="px-6 py-4">{item.carbs}</td>
